...
class Index:
    ...
    def __init__(self, idx_list    ):
        self.idx_list  = None  # using array type for index list will make things easier
...
class LocIndexer:
    ...
    def __init__(self, index_data , indices , int_loc  = False):
    ...
    @staticmethod
    def proc_idx_l(indices   , data_shape  = None)  :
    ...
    def _slc_convert(self, index , indexing )  :
        """
...
class IndexData(metaclass=index_data_ops_creator):
    ...
    def __init__(self, data , *indices   ):
        ...
        self.indices  = self.loc_idx_cls.proc_idx_l(indices, data_shape)
    ...
    def fillna(self, value=0.0, inplace  = False):
        if inplace:
