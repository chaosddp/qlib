...
class TradeCalendarManager:
    ...
    def get_data_cal_range(self, rtype  = "full")   :
        """
    ...
    # helper functions
    def get_range_idx(self, start_time , end_time )   :
        """
