...
class BaseExecutor:
    ...
    def execute(self, trade_decision , level  = 0)  :
...
class NestedExecutor(BaseExecutor):
    ...
    def _update_trade_decision(self, trade_decision )  :
...
def _retrieve_orders_from_decision(trade_decision )  :
    """
