...
class Order:
    ...
    deal_amount  = 0.0  # `deal_amount` is a non-negative value
    factor  = None
...
class IdxTradeRange(TradeRange):
    ...
    def __call__(self, trade_calendar  = None)   :
...
class BaseTradeDecision(Generic[DecisionType]):
    ...
    def _get_range_limit(self, **kwargs )   :
    ...
    def mod_inner_decision(self, inner_trade_decision )  :
        """
