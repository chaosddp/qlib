...
class AccumulatedInfo:
    ...
    def reset(self)  :
        self.rtn  = 0.0  # accumulated return, do not consider cost
        self.cost  = 0.0  # accumulated cost
        self.to  = 0.0  # accumulated turnover
...
class Account:
    ...
    def __init__(
        ...
        self.benchmark_config  = {}  # avoid no attribute error
        self.init_vars(init_cash, position_dict, freq, benchmark_config)

    def init_vars(self, init_cash , position_dict , freq , benchmark_config )  :
        ...
        self.current_position  = init_instance_by_config(
            {
    ...
    def reset(self, freq  = None, benchmark_config  = None, port_metr_enabled  = None)  :
