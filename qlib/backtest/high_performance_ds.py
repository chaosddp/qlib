...
class BaseQuote:
    def __init__(self, quote_df , freq )  :
...
class NumpyQuote(BaseQuote):
    def __init__(self, quote_df , freq , region  = "cn")  :
        """NumpyQuote
...
class BaseOrderIndicator:
    ...
    def transfer(self, func , new_col  = None)  :
    ...
    def get_metric_series(self, metric )  :
