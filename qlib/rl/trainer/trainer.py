...
class Trainer:
    ...
    def __init__(
        ...
        *,
        ...
        self.vessel  = cast(TrainingVesselBase, None)
    ...
    def fit(self, vessel , ckpt_path    = None)  :
    ...
    def venv_from_iterator(self, iterator )  :
    ...
    def _metrics_callback(self, on_episode , on_collect , log_buffer )  :
        if on_episode:
    ...
    def _call_callback_hooks(self, hook_name , *args , **kwargs )  :
