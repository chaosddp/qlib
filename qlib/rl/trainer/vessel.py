...
class TrainingVessel(TrainingVesselBase):
    ...
    def __init__(
        ...
        *,
        ...
        policy ,
        reward ,
        train_initial_states    = None,
        val_initial_states    = None,
        test_initial_states    = None,
        buffer_size  = 20000,
        episode_per_iter  = 1000,
        update_kwargs   = cast(Dict[str, Any], None),
    ):
    ...
    @staticmethod
    def _random_subset(name , collection , size   )  :
        if size is None:
