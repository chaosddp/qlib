...
class Callback:
    ...
    def on_fit_start(self, trainer , vessel )  :
        """Called before the whole fit process begins."""

    def on_fit_end(self, trainer , vessel )  :
        """Called after the whole fit process ends."""

    def on_train_start(self, trainer , vessel )  :
        """Called when each collect for training begins."""

    def on_train_end(self, trainer , vessel )  :
    ...
    def on_validate_start(self, trainer , vessel )  :
        """Called when every run for validation begins."""

    def on_validate_end(self, trainer , vessel )  :
        """Called when the validation ends."""

    def on_test_start(self, trainer , vessel )  :
        """Called when every run of testing begins."""

    def on_test_end(self, trainer , vessel )  :
        """Called when the testing ends."""

    def on_iter_start(self, trainer , vessel )  :
...
class Checkpoint(Callback):
    ...
    def _new_checkpoint_name(self, trainer )  :
