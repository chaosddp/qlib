...
class LogCollector:
    ...
    def __init__(self, min_loglevel    = LogLevel.PERIODIC)  :
    ...
    def _add_metric(self, name , metric , loglevel   )  :
    ...
    def add_string(self, name , string , loglevel    = LogLevel.PERIODIC)  :
    ...
    def add_scalar(self, name , scalar , loglevel    = LogLevel.PERIODIC)  :
    ...
    def add_any(self, name , obj , loglevel    = LogLevel.PERIODIC)  :
...
class LogWriter(Generic[ObsType, ActType]):
    ...
    def __init__(self, loglevel    = LogLevel.PERIODIC)  :
    ...
    @staticmethod
    def aggregation(array , name    = None)  :
    ...
    def on_env_reset(self, env_id , obs )  :
...
class LogBuffer(LogWriter):
    ...
    def __init__(self, callback    , loglevel    = LogLevel.PERIODIC):
    ...
    def clear(self):
        ...
        self._aggregated_metrics   = defaultdict(float)

    def log_episode(self, length , rewards , contents  )  :
        # FIXME Dup of ConsoleWriter
        episode_wise_contents   = defaultdict(list)
...
class ConsoleWriter(LogWriter):
    ...
    def generate_log_message(self, logs  )  :
        if self.prefix:
...
class CsvWriter(LogWriter):
    ...
    def __init__(self, output_dir , loglevel    = LogLevel.PERIODIC)  :
        super().__init__(loglevel)
