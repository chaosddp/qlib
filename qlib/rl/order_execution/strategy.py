...
class SAOEStrategy(RLStrategy):
    ...
    def __init__(
        self,
        policy ,  # TODO: add accurate typehint later.
    ...
    def _create_qlib_backtest_adapter(self, order , trade_range )  :
    ...
    def get_saoe_state_by_order(self, order )  :
...
class ProxySAOEStrategy(SAOEStrategy):
    ...
    def _generate_trade_decision(self, execute_result  = None)    :
...
class SAOEIntStrategy(SAOEStrategy):
    ...
    def __init__(
        ...
        state_interpreter   ,
        action_interpreter   ,
        network  = None,  # TODO: add accurate typehint later.
        outer_trade_decision  = None,
        level_infra  = None,
        common_infra  = None,
        backtest  = False,
        **kwargs ,
        ...
        self._state_interpreter  = init_instance_by_config(
            state_interpreter,
            accept_types=StateInterpreter,
        )
        self._action_interpreter  = init_instance_by_config(
            action_interpreter,
