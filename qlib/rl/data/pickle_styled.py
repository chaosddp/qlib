...
def _find_pickle(filename_without_suffix )  :
...
def _read_pickle(filename_without_suffix )  :
...
class SimpleIntradayBacktestData(BaseIntradayBacktestData):
    ...
    def __init__(
        ...
        self.data  = backtest
        self.deal_price_type  = deal_price
...
class IntradayProcessedData(BaseIntradayProcessedData):
    ...
    def __init__(
        ...
        self.today  = proc_today
        self.yesterday  = proc_yesterday
